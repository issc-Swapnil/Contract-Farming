...
$query="update notification set status=1 where status=0 AND userId=".$_SESSION['userId'];
$conn->query($query);
?>
 ...
 <div class="page">
   <div class="page-header">
        ...
        <div class="page-content container-fluid">
          ...
          {
            ?>
              <table class="table table-hover dataTable table-striped w-full" data-plugin="dataTable" style="table-layout: fixed">
              <thead>
                <tr>
              ...
              do
            {
              ?>
                <tr>
                  ...
                  <td style="word-wrap: break-word"><?php echo $row['message']; ?></td>
                </tr>
                <?php
