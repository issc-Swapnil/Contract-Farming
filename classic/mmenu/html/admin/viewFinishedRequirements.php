...
<html class="no-js css-menubar" lang="en">
  <head>
    ...
    <title>Finished Requirements</title>
    ...
    <div class="site-menubar">
     ...
     <!-- Page -->
      ...
      <div class="panel">
          ...
          <?php
          $query="select reqId,cropId,quantity from requirement where status=1";
          $result=$conn->query($query);
          if($row = $result->fetch_assoc())
          {
            ?>
              ...
              do
            {
              ...
              $query3="select count(contractId) as num,sum(totalCost) as total from contract where reqId=".$row['reqId']." group by reqId";
                ...
                <div class="col-sm-12 col-md-4 col-xl-2">
                      <div class="example">
                        <ul class="list-unstyled">
                          <li class="mb-20">
                            <input type="submit" class="btn btn-block btn-primary" name="renew" value="Renew Requirement" />
                          </li>
                        </ul>
                      </div>
                    </div>
          ...
          ?>
            <div >
                  No requirements fulfilled! See if there is a pending one...
                  <center>
                <div class="col-sm-12 col-md-4 col-xl-2">
                      <div class="example">
                        <ul class="list-unstyled">
                          <li class="mb-20">
                            <button class="btn btn-block btn-primary" id="redirect" onclick="location.href = 'viewCurrentRequirements.php';">Pending Requirements</button>
                          </li>
                        </ul>
                      </div>
                    </div>
