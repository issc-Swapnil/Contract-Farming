...
<div class="page">
   <div class="page-header">
            <h1 class="page-title">Offered Contracts</h1>
          </div>
        <div class="page-content container-fluid">
          <div class="panel">
          <div class="panel-body">
          <?php
          $query="select * from contract where status=1";
          $result=$conn->query($query);
          if($row = $result->fetch_assoc())
          {
            ?>
            <form method="post" action="viewOfferedContracts.php">
                    ...
                    <div class="col-sm-12 col-md-4 col-xl-2">
                      <div class="example">
                        <ul class="list-unstyled">
                          <li class="mb-20">
                            <input type="submit" class="btn btn-block btn-primary" name="cancel" value="Retract offer" />
                          </li>
                        </ul>
                      </div>
                    </div>
          ...
          ?>
            <div >
                  No contracts offered! Send a request today!
                  <center>
                <div class="col-sm-12 col-md-4 col-xl-2">
                      <div class="example">
                        <ul class="list-unstyled">
