  ...
  <body class="animsition site-navbar-small ">
    ...
    <!-- Page -->
       ...
       <div class="page-header">
        <h1 class="page-title">Pending Requirements</h1>
        </div>
                ...
                <div class="col-sm-12 col-md-4 col-xl-2">
                      <div class="example">
                        <ul class="list-unstyled">
                          <li class="mb-20">
                            <button type="submit" class="btn btn-block btn-primary" id="redirect" onclick="location.href = 'viewFarmerProfiles.php';">Request Contract</button>
                          </li>
                        </ul>
                      </div>
                    </div>
            ...
            <div >
                ...
                <div class="col-sm-12 col-md-4 col-xl-2">
                      <div class="example">
                        <ul class="list-unstyled">
                          <li class="mb-20">
                            <button type="submit" class="btn btn-block btn-primary" id="redirect" onclick="location.href = 'newRequirement.php';">New Requirement</button>
                          </li>
                        </ul>
                      </div>
                    </div>
