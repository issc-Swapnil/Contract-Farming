...
<html class="no-js css-menubar" lang="en">
  <head>
    ...
    <title>Completed Contracts</title>
...
<div class="page">
   <div class="page-header">
            <h1 class="page-title">Completed Contracts</h1>
          </div>
        <div class="page-content container-fluid">
        <form method="post" action="../farmer/invoice.php">
          <div class="panel">
          <div class="panel-body">
          <?php
          $query="select * from contract where status=5";
          $result=$conn->query($query);
          if($row = $result->fetch_assoc())
          {
            ?>
              ...
              do
            {
              ...
              ?>
                <tr>
                  <td><input type="radio" name="contractId" value="<?php echo $row['contractId']; ?>" required/>
          ...
          ?>
            <div >
                  No Contracts Completed yet! Form a contract TODAY!
            </div>
          <?php
          }
          ?>
