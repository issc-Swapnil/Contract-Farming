...
if(isset($_POST['submit']))
{
  ...
  $sql="INSERT INTO supply(supplyName,costPerUnit,supplyCategory)VALUES('$a','$b','$c')";
...
<div class="page">
  <div class="page-header">
        <h1 class="page-title">Supply Master</h1>
  </div>

  <div class="page-content  container-fluid">

        <!-- Panel Form Elements -->
    <form method="post" action="supplyMaster.php">
    <div class="row">
      <div class="col-md-6 col-lg-4">
           <!-- Example Card Columns -->
        <div class="example-wrap">
          <div class="card card-block">
            <h4 class="card-title">Add New Supply</h4>
            <?php
              if ($error==1)
              {
              ?>
              <div class="d-block small" style="color: green">Supply Added</div>
              <?php
              }
              elseif ($error==2)
              { 
              ?>
              <div class="d-block small" style="color: red">Error while adding supply</div>
              <?php
              }
              ?>
            <div class="form-group form-material floating" data-plugin="formMaterial">
              <input type="text" class="form-control" name="name" required/>
              <label class="floating-label">Supply Name</label>
            </div>
            <div class="form-group form-material floating" data-plugin="formMaterial">
              ...
              <label class="floating-label">Supply Category</label>
            </div>
            <div class="form-group form-material floating" data-plugin="formMaterial">
              <input type="number" class="form-control" name="cost" min="1" value="100" required/>
              <label class="floating-label">Cost per Unit(Rs.)</label>
            </div>
            <div class="row">
      ...
      <div class="col-md-6 col-lg-8">
        <div class="example-wrap">
          <div class="card card-block">
            ...
            <table table class="table table-hover dataTable table-striped w-full" data-plugin="dataTable">
              <thead>
                <th>Name</th>
                <th>Category</th>
                <th>Cost Per Unit</th>
              ...
              <tbody valign="top">
                  <?php
                $query="select * from supply order by supplyName";
                $result=$conn->query($query);
                ...
                <tr>
                  ...
                  <td><?php echo $row['supplyCategory']; ?></td>
                  <td>Rs. <?php echo $row['costPerUnit']; ?></td>
                </tr>
                <?php } ?>
              </tbody>
            </table>
