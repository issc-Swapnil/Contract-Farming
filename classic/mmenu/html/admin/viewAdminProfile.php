    ...
    <div class="page">
      <div class="page-header">
        ...
        <div class="page-header-actions">
          <button type="button" class="btn btn-sm btn-icon btn-default btn-outline btn-round" data-toggle="tooltip" data-original-title="Edit" onclick="window.location.href='editAdminProfile.php'">
            ...
            <div class="panel-body">
              <div class="row">
                <div class="col-md-6 col-lg-8">
                  ...
                  <p class="form-control-plaintext"><?php echo fgets($fileRead); ?></p>
                </div>
